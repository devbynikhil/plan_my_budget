    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-gray-500 mt-2">
              This will check all recurring transactions and send reminders for
              those due today
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="mt-6">
        <CardHeader>
          ...
          <CardDescription>
            Follow these steps to set up automated recurring transaction
            reminders
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="mt-2 rounded bg-secondary p-3 text-sm font-mono">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  You can use Vercel Cron, GitHub Actions, or any external cron
                  service
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Use the test buttons above to verify emails are working, then
                  create some recurring transactions to test
                </p>
              </div>
            </div>
          </div>
